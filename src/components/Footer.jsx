...
const Footer = () => {
    return (
        <div data-scroll data-scroll-section data-scroll-speed=".1" className="flex gap-5 w-full h-screen p-20">
            ...
            <div className="w-1/2 font-medium">
                <h1 className='text-[5vw] font-medium uppercase leading-none'>Presentations</h1>
                ...
                <div className="dets mt-10 ">
                    ...
                    <a className='block underline text-xl font-light ' href="">Behance</a>
                </div>
                ...
                <div className='mt-12'> <a href="">30 Chukarina <br /> St
                    Lviv, Ukraine</a>
                </div>

                <div className='mt-16'>
                    <h1 className='pb-5'>E:</h1>
